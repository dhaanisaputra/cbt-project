            ...
            <div class="header ml-[70px] pr-[70px] w-[940px] flex items-center justify-between mt-10">
                <div class="flex gap-6 items-center">
                    <div class="w-[150px] h-[150px] flex shrink-0 relative overflow-hidden">
                        <img src="{{Storage::url($course->cover)}}" class="w-full h-full object-contain" alt="icon" onerror="this.src='{{asset('images/icons/course-placeholder.svg')}}'">
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="flex items-center gap-5">
                            ...
                            <div class="flex gap-[10px] items-center">
                                ...
                                <p class="font-semibold">{{count($student)}} students</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <form method='POST' action="{{route('dashboard.course_questions.update', $courseQuestion)}}" id="add-question" class="mx-[70px] mt-[30px] flex flex-col gap-5">
                ...
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div class="flex items-center w-[500px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] focus-within:border-2 focus-within:border-[#0A090B]">
                        ...
                        <input type="text" value="{{$courseQuestion->question}}" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" placeholder="Write the question" name="question" required>
                    </div>
                </div>
                <div class="flex flex-col gap-[10px]">
